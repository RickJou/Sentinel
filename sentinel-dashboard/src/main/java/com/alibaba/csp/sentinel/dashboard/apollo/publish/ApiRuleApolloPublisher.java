 ...
 * @since 1.5.0
 */
@Component("apiRuleApolloPublisher")
public class ApiRuleApolloPublisher implements DynamicRulePublisher<List<ApiDefinitionEntity>> {
    ...
    public void publish(String app, List<ApiDefinitionEntity> rules) throws Exception {
        String flowDataId = ApolloConfigUtil.getGateWayApiDataId(app);
