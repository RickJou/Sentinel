 ...
 * @since 1.5.0
 */
@Component("apolloPublisher")
public class ApolloPublisher {
     ...
     * @param app
     * @param apploRowKey
     * @param rules       : GatewayFlowRuleEntity or FlowRuleEntity
     * @throws Exception
     */
    public void publish(String app, String apploRowKey, List rules) throws Exception {
        ...
        openItemDTO.setKey(apploRowKey);
